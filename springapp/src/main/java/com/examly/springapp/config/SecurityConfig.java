    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.PUT, "/api/trainer/{trainerId}").hasAnyRole("Manager", "Coordinator")
                .requestMatchers(HttpMethod.DELETE, "/api/trainer/{trainerId}").hasAnyRole("Manager", "Coordinator")
